...
(function() {
    var scriptUrl = 'https://cdn.jsdelivr.net/gh/MekoMedia/damp@main/lib/err/ChunkJSDeliver0.0.0.js';
    var maxRetries = 3;
    var retryCount = 0;
    ...
    function showShutdownPage() {
        ...
        if (shutdownPage) {
            ...
            div.innerHTML = `
                ...
                <div class="block-code">Server is on Maintenance, please come back later</div>
